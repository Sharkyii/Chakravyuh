...
| 15–17 Aug | **Base generator** | Party/device/merchant populations; legitimate traffic with credible marginals; validated against IEEE-CIS, PaySim, BankSim, ULB, Elliptic |
