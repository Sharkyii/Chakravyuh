...
| G15 | `balance_drain_exit` | *(none - added post-freeze)* | Large inbound transfer immediately followed by an 85–95% payout to a newly-added beneficiary within 5 minutes (a well documented receive-then-drain signature) |
