...
def test_preprocessor_includes_all_features():
    ...
    for feat in BEHAVIORAL_FEATURES:
        ...
        assert (
            expected_name in feature_names
        ), f"Behavioral feature {feat} was dropped or has incorrect output name"
    ...
    for feat in GRAPH_FEATURES:
        ...
        assert (
            expected_name in feature_names
        ), f"Graph feature {feat} was dropped or has incorrect output name"
